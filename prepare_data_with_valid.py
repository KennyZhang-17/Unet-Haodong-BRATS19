...
HGG_data_path = "data/Brats19TrainingData/HGG"
LGG_data_path = "data/Brats19TrainingData/LGG"
survival_csv_path = "data/Brats19TrainingData/survival_data.csv"
###==========================================================================###
...
with open(survival_csv_path, 'r') as f:
    ...
    for idx, content in enumerate(reader):
        ...
        survival_age_list.append(content[1])
        survival_peroid_list.append(content[2])
...
if DATA_SIZE == 'all':
    ...
    HGG_path_list = tl.files.load_folder_list(path=HGG_data_path)[0:20] # DEBUG WITH SMALL DATA 50
    LGG_path_list = tl.files.load_folder_list(path=LGG_data_path)[0:8] # DEBUG WITH SMALL DATA 20
else:
